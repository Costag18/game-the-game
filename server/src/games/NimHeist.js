...
import { NimHeistMatch } from './NimHeistMatch.js';
import { TIMERS } from '../../../shared/constants.js';

/**
 * Nim Heist — Misère Nim, inherently 1v1, wrapped by the PairingEngine into a
 ...
 * live in PairingEngine, and one board lives in NimHeistMatch.
 */
export class NimHeist extends PairingEngine {
  constructor(players) {
    super(players, {
      matchFactory: (p1, p2) => new NimHeistMatch(p1, p2),
      miniRounds: 3,
