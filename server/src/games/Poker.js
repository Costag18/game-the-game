...
const FSM = {
  ...
  transitions: {
    ...
    preflop: { deal: 'flop', finish: 'finished', reveal: 'reveal' },
    flop: { deal: 'turn', finish: 'finished', reveal: 'reveal' },
    turn: { deal: 'river', finish: 'finished', reveal: 'reveal' },
    river: { showdown: 'showdown', finish: 'finished', reveal: 'reveal' },
